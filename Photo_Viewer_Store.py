...
TRANSLATIONS = {
    "tr": {
        ...
        "settings_saved_msg": "Ayarlar kaydedildi!\nKayıt yeri:\n{}",
        "file_not_found_msg": "Dosya bulunamadı:\n{}",
        "email_subject_label": "Fotoğraf: {}",
        "email_attached_label": "Fotoğraf ektedir: {}",
        "email_via_branding": "Windows Fotoğraf Görüntüleyicisi ile gönderildi.",
        "email_no_outlook_msg": "Outlook bulunamadı.\nVarsayılan e-posta uygulaması açıldı.\n\nDosya:\n{}\n\nLütfen dosyayı maile sürükleyip ekleyin.",
        "email_failed_msg": "E-posta gönderilemedi:\n{}\n\nDosya:\n{}",
        "err_no_winreg": "winreg bulunamadı",
        "err_windows_only": "Sadece Windows",
        "default_file_desc": "Windows Fotoğraf Görüntüleyicisi Resmi",
        "slideshow_suffix_sec": " sn",
        "color_picker_title": "Renk seç",
        "store_default_apps_msg": "Microsoft Store surumunde dosya iliskilendirmeleri manifest uzerinden otomatik yapilir.\nVarsayilan uygulamalar ayarlari aciliyor...",
    },
    "en": {
        ...
        "email_subject_label": "Photo: {}",
        "email_attached_label": "Photo attached: {}",
        "email_via_branding": "Sent via Windows Photo Viewer.",
        "email_no_outlook_msg": "Outlook not found.\nDefault email app opened.\n\nFile:\n{}\n\nPlease drag the file into the email.",
        "email_failed_msg": "Could not send email:\n{}\n\nFile:\n{}",
        "err_no_winreg": "winreg not available",
        "err_windows_only": "Windows only",
        "default_file_desc": "Windows Photo Viewer Picture",
        "slideshow_suffix_sec": " s",
        "color_picker_title": "Select color",
        "store_default_apps_msg": "In the Microsoft Store version, file associations are handled automatically via the manifest.\nOpening default apps settings...",
    },
    "de": {
        ...
        "file_not_found_msg": "Datei nicht gefunden:\n{}",
        "email_subject_label": "Foto: {}",
        "email_attached_label": "Foto angehaengt: {}",
        "email_via_branding": "Gesendet mit Windows Fotoanzeige.",
        "email_no_outlook_msg": "Outlook nicht gefunden.\nStandard-E-Mail-App geoeffnet.\n\nDatei:\n{}\n\nBitte Datei in die E-Mail ziehen.",
        "email_failed_msg": "E-Mail konnte nicht gesendet werden:\n{}\n\nDatei:\n{}",
        "err_no_winreg": "winreg nicht verfuegbar",
        "err_windows_only": "Nur Windows",
        "default_file_desc": "Windows Fotoanzeige Bild",
        "slideshow_suffix_sec": " s",
        "color_picker_title": "Farbe waehlen",
        "store_default_apps_msg": "In der Microsoft-Store-Version werden Dateizuordnungen automatisch ueber das Manifest festgelegt.\nStandard-Apps-Einstellungen werden geoeffnet...",
    },
    "fr": {
        ...
        "settings_saved_msg": "Parametres enregistres!\nEnregistre dans:\n{}",
        "file_not_found_msg": "Fichier introuvable:\n{}",
        "email_subject_label": "Photo: {}",
        "email_attached_label": "Photo jointe: {}",
        "email_via_branding": "Envoye via Windows Visionneuse de photos.",
        "email_no_outlook_msg": "Outlook introuvable.\nApplication de messagerie par defaut ouverte.\n\nFichier:\n{}\n\nVeuillez glisser le fichier dans l'e-mail.",
        "email_failed_msg": "Impossible d'envoyer l'e-mail:\n{}\n\nFichier:\n{}",
        "err_no_winreg": "winreg non disponible",
        "err_windows_only": "Windows uniquement",
        "default_file_desc": "Image Windows Visionneuse de photos",
        "slideshow_suffix_sec": " s",
        "color_picker_title": "Choisir couleur",
        "store_default_apps_msg": "Dans la version Microsoft Store, les associations de fichiers sont automatiques via le manifeste.\nOuverture des parametres des applications par defaut...",
    },
    "es": {
        ...
        "settings_saved_msg": "Ajustes guardados!\nGuardado en:\n{}",
        "file_not_found_msg": "Archivo no encontrado:\n{}",
        "email_subject_label": "Foto: {}",
        "email_attached_label": "Foto adjunta: {}",
        "email_via_branding": "Enviado mediante Windows Visor de fotos.",
        "email_no_outlook_msg": "Outlook no encontrado.\nSe abrio la aplicacion de correo predeterminada.\n\nArchivo:\n{}\n\nArrastre el archivo al correo.",
        "email_failed_msg": "No se pudo enviar el correo:\n{}\n\nArchivo:\n{}",
        "err_no_winreg": "winreg no disponible",
        "err_windows_only": "Solo Windows",
        "default_file_desc": "Imagen de Windows Visor de fotos",
        "slideshow_suffix_sec": " s",
        "color_picker_title": "Elegir color",
        "store_default_apps_msg": "En la version de Microsoft Store, las asociaciones de archivos son automaticas mediante el manifiesto.\nAbriendo la configuracion de aplicaciones predeterminadas...",
    },
    "it": {
        ...
        "file_not_found_msg": "File non trovato:\n{}",
        "email_subject_label": "Foto: {}",
        "email_attached_label": "Foto allegata: {}",
        "email_via_branding": "Inviato tramite Windows Visualizzatore foto.",
        "email_no_outlook_msg": "Outlook non trovato.\nApp email predefinita aperta.\n\nFile:\n{}\n\nTrascina il file nell'email.",
        "email_failed_msg": "Impossibile inviare l'email:\n{}\n\nFile:\n{}",
        "err_no_winreg": "winreg non disponibile",
        "err_windows_only": "Solo Windows",
        "default_file_desc": "Immagine Windows Visualizzatore foto",
        "slideshow_suffix_sec": " s",
        "color_picker_title": "Scegli colore",
        "store_default_apps_msg": "Nella versione Microsoft Store, le associazioni file sono automatiche tramite il manifest.\nApertura impostazioni app predefinite...",
    },
    "pt": {
        ...
        "settings_saved_msg": "Configuracoes salvas!\nSalvo em:\n{}",
        "file_not_found_msg": "Arquivo nao encontrado:\n{}",
        "email_subject_label": "Foto: {}",
        "email_attached_label": "Foto anexada: {}",
        "email_via_branding": "Enviado via Windows Visualizador de fotos.",
        "email_no_outlook_msg": "Outlook nao encontrado.\nAplicativo de e-mail padrao aberto.\n\nArquivo:\n{}\n\nArraste o arquivo para o e-mail.",
        "email_failed_msg": "Nao foi possivel enviar o e-mail:\n{}\n\nArquivo:\n{}",
        "err_no_winreg": "winreg nao disponivel",
        "err_windows_only": "Somente Windows",
        "default_file_desc": "Imagem do Windows Visualizador de fotos",
        "slideshow_suffix_sec": " s",
        "color_picker_title": "Escolher cor",
        "store_default_apps_msg": "Na versao da Microsoft Store, as associacoes de arquivo sao automaticas via manifesto.\nAbrindo configuracoes de aplicativos padrao...",
    },
    "pl": {
        ...
        "settings_saved_msg": "Ustawienia zapisane!\nZapisano w:\n{}",
        "file_not_found_msg": "Nie znaleziono pliku:\n{}",
        "email_subject_label": "Zdjecie: {}",
        "email_attached_label": "Zdjecie zalaczone: {}",
        "email_via_branding": "Wyslano przez Przegladarke zdjec Windows.",
        "email_no_outlook_msg": "Nie znaleziono Outlooka.\nOtwarto domyslna aplikacje pocztowa.\n\nPlik:\n{}\n\nPrzeciagnij plik do wiadomosci e-mail.",
        "email_failed_msg": "Nie mozna wyslac e-maila:\n{}\n\nPlik:\n{}",
        "err_no_winreg": "winreg niedostepny",
        "err_windows_only": "Tylko Windows",
        "default_file_desc": "Obraz Przegladarki zdjec Windows",
        "slideshow_suffix_sec": " s",
        "color_picker_title": "Wybierz kolor",
        "store_default_apps_msg": "W wersji Microsoft Store skojarzenia plikow sa automatyczne przez manifest.\nOtwieranie ustawien aplikacji domyslnych...",
    },
}
...
class ThemeSettingsDialog(QDialog):
    def __init__(self, parent, current_settings):
        ...
        self.setWindowTitle(self.t("theme_settings_title"))
        self.setMinimumSize(520, 480)
        self.resize(580, 560)
        self.init_ui()

    def t(self, key):
        lang = self.current_settings.get("language", "tr")
    ...
    def init_ui(self):
        ...
        self.chk_accent = QCheckBox(self.t("theme_auto_accent"))
        ...
        # Renkler
        color_group = QGroupBox(self.t("theme_colors_group"))
        ...
        color_form.addRow(self.t("theme_top_color"), self.btn_top_color)
        ...
        color_form.addRow(self.t("theme_bottom_color"), self.btn_bottom_color)
        ...
        color_form.addRow(self.t("theme_bg_color"), self.btn_bg_color)

        theme_layout.addWidget(color_group)

        # Font
        font_group = QGroupBox(self.t("theme_font_group"))
        font_form = QFormLayout(font_group)

        self.combo_font = QFontComboBox()
        fam = self.current_settings["theme"].get("font_family", "Segoe UI")
        self.combo_font.setCurrentFont(QFont(fam))
        font_form.addRow(self.t("theme_font_label"), self.combo_font)

        self.spin_size = QSpinBox()
        self.spin_size.setRange(6, 24)
        self.spin_size.setValue(self.current_settings["theme"].get("font_size", 9))
        font_form.addRow(self.t("theme_size_label"), self.spin_size)

        self.chk_text_auto = QCheckBox(self.t("theme_text_auto"))
        ...
        tabs.addTab(theme_tab, self.t("theme_tab"))

        # TAB 2 - DIL
        lang_tab = QWidget()
        lang_layout = QVBoxLayout(lang_tab)
        lang_layout.addWidget(QLabel(self.t("lang_select_label")))
        ...
        tabs.addTab(lang_tab, self.t("lang_tab"))

        # TAB 3 - DOSYA TURleri
        ext_tab = QWidget()
        ext_layout = QVBoxLayout(ext_tab)
        ext_layout.addWidget(QLabel(self.t("ext_select_label")))
    ...
    def pick_color(self, which):
        ...
        col = QColorDialog.getColor(current, self, f"{self.t('color_picker_title')} - {which}")
        if col.isValid():
            if which == "top":
                self.top_color = col
...
class Win7Viewer(QMainWindow):
    ...
    def start_slideshow_dialog(self):
        ...
        spin.setSuffix(self.t('slideshow_suffix_sec'))
        lay.addWidget(spin)
    ...
    def start_slideshow(self, interval_sec=3, fullscreen=False):
        ...
        self.btn_center.setToolTip(self.t('slideshow_stop_tip') + f" ({interval_sec}{self.t('slideshow_suffix_sec')})")
    ...
    def retranslate_ui(self):
        ...
        self.act_set_default.setText(self.t('settings_set_default')); self.act_theme.setText(self.t('theme_settings_title')+'...'); self.act_auto_detect.setText(self.t('settings_auto_detect')); self.lang_menu.setTitle(self.t('settings_language')); self.act_about.setText(self.t('help_about'))
    ...
    def open_theme_settings(self):
        ...
        if dlg.exec() == QDialog.DialogCode.Accepted:
            ...
            self.retranslate_ui()
            self.apply_accent_color()
            QMessageBox.information(self, self.t('menu_settings'), self.t('settings_saved_msg').format(get_settings_path()))
    ...
    def action_set_default(self):
        QMessageBox.information(self, self.t('settings_set_default'), self.t('store_default_apps_msg'))
        try:
    ...
    def email_image(self):
        ...
        if not os.path.exists(img_path):
            QMessageBox.warning(self, self.t('file_email'), self.t('file_not_found_msg').format(img_path))
            return
        try:
            ...
            mail.Body = f"{os.path.basename(img_path)} - {self.t('email_via_branding')}\n\n"
        ...
        try:
            import urllib.parse
            subject = urllib.parse.quote(self.t('email_subject_label').format(os.path.basename(img_path)))
            body = urllib.parse.quote(f"{self.t('email_attached_label').format(img_path)}\n\n{self.t('email_via_branding')}")
            ...
            QMessageBox.information(self, self.t('file_email'), self.t('email_no_outlook_msg').format(img_path))
        except Exception as e:
            QMessageBox.warning(self, self.t('file_email'), self.t('email_failed_msg').format(e, img_path))
    def burn_image(self):
