...
class Win7Viewer(QMainWindow):
    ...
    def action_set_default(self):
        QMessageBox.information(self, self.t('settings_set_default'), "Microsoft Store surumunde dosya iliskilendirmeleri manifest uzerinden otomatik yapilir.\nFile associations are automatic in Store version.\n\nVarsayilan uygulamalar ayarlari aciliyor...")
        try:
